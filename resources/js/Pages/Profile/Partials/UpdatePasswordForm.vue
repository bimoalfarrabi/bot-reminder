...
<template>
    <section>
        <header>
            <h2 class="text-sm font-mono font-semibold text-[#e6edf3]">Update Password</h2>
            <p class="mt-1 text-xs font-mono text-[#8b949e]">Ensure your account is using a long, random password to stay secure.</p>
        </header>
